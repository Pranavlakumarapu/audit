            ...
            <div className='row'>
                     ...
                     <div className='main'>
                        <div className='service'>
                          ...
                          <h4 className='servicename'> <i className="fa-solid fa-pencil"></i> Customized solutions</h4>
                          <p>
                     ...
                     <div className='main'>
                        <div className='service'>
                          ...
                          <h4 className='servicename'> <i className="fa-solid fa-code"></i> Integration Solutions</h4>
                          <p>
                     ...
                     <div className='main'>
                        <div className='service'>
                              <h4 className='servicename'>  <i className="fa-sharp fa-solid fa-gear"></i> Technical Support</h4>
                          <p>
