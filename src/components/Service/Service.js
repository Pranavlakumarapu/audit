          ...
          <div className='container'>
            <div className='row'>
                {/* box 1 */}
                     ...
                     <div className='main'>
                        <div className='service'>
                          ...
                          <h4 className='servicename'> <i class="fa-solid fa-pencil"></i> Customized solutions</h4>
                          <p>
                ...
                {/* Box 2 */}
                     ...
                     <div className='main'>
                        <div className='service'>
                          ...
                          <h4 className='servicename'> <i class="fa-solid fa-code"></i> Integration Solutions</h4>
                          <p>
                ...
                {/* box3 */}
                     ...
                     <div className='main'>
                        <div className='service'>
                              <h4 className='servicename'>  <i class="fa-sharp fa-solid fa-gear"></i> Technical Support</h4>
                          <p>
